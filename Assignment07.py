...
#   Patrick Renie, 8/25/25, Created Script
# ---------------------------------------------------------------------- #
import json
...
class Person:
    ...
    def __str__(self):
        return (f"This is a Person class instance for "
                f"{self._first_name} {self.last_name}")
...
class Student(Person):
    """
    A class for student data. Subclass of the Person class.
    """
    ...
    def __str__(self):
        return (f"This is a Student class instance for "
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str):
        ...
        list of dictionary rows then returns the list filled with student data.
...
class IO:
    ...
    def input_menu_choice():
        ...
        try:
            ...
            IO.output_error_messages(
                e.__str__())  # Not passing e to avoid the technical message
